import svgPaths from "./svg-vd3t1mrzet";
...
function Icon6() {
  return (
    <div className="absolute left-0 size-[15.996px] top-[2px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_28_3240)" id="Icon">
...
function Icon7() {
  return (
    <div className="absolute left-0 size-[15.996px] top-0" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_28_3236)" id="Icon">
